...
public class Server extends AbstractVerticle {
  ...
  public void start() throws Exception {
    ...
    BridgeOptions options = new BridgeOptions().addOutboundPermitted(new PermittedOptions().setAddress(busAddress));
    ...
    vertx.setPeriodic(1000, t -> vertx.eventBus().publish("paintAddress", "Server Now " + new java.util.Date()));
